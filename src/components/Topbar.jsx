      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {isDropdownOpen && (
              <div className="absolute top-12 right-0 w-60 bg-white rounded-xl shadow-xl border border-slate-100 py-2 animate-in fade-in zoom-in-95 duration-200 origin-top-right">
